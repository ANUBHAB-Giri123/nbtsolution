...
export default function Overview() {
  ...
  return (
    <>
      {/* ================= BLACK SECTION ================= */}
      <div className="w-full flex justify-center py-10 md:py-16 bg-gray-100 px-4">
        <div className="w-full max-w-6xl bg-black text-white rounded-[30px] md:rounded-[40px] px-6 md:px-10 py-10 md:py-20">
          ...
          <div className="mt-10 bg-white text-black rounded-[20px] md:rounded-[30px] p-4 md:p-6 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <button className="bg-black text-white px-5 py-2 md:px-6 md:py-3 rounded-full text-sm md:text-base">
              Let’s Talk →
            </button>
          </div>
        </div>
      ...
      <div className="bg-white w-full py-16 flex flex-col items-center">
        <div className="max-w-[900px] text-center px-4">
          ...
          <div className="mt-6 md:mt-10 flex justify-center">
            <button className="border border-gray-400 px-5 md:px-8 py-2 md:py-3 rounded-full text-sm md:text-base">
              Tailored Solution For Every Project
            </button>
          </div>
        </div>
        ...
        {/* CARDS */}
        <div className="mt-10 md:mt-16 flex flex-wrap gap-6 md:gap-8 justify-center">
          <Card dark={true} />
          <Card dark={false} />
          <Card dark={false} />
        </div>
      ...
      {/* ================= HOW WE WORK ================= */}
      <div className="w-full bg-gray-100 flex justify-center py-16 px-4">
        <div className="w-full max-w-6xl bg-gradient-to-r from-black via-gray-800 to-gray-200 rounded-[30px] md:rounded-[40px] p-6 md:p-10 flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 text-white text-center lg:text-left">
            ...
            <p className="text-gray-300 mb-6 md:mb-10 text-sm md:text-base">
              Answers To Your Most Asked Questions
            </p>

            <div className="w-[200px] md:w-[350px] lg:w-[450px] mx-auto lg:mx-0">
              <img
                src={ball}
                alt="ball"
            ...
            {steps.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  onClick={() => setActive(index)}
                  className={`rounded-[20px] md:rounded-[25px] p-4 md:p-6 cursor-pointer transition ${
                    isActive
                      ? "bg-black text-white"
                      : "bg-gray-200 text-black"
                  }`}
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="w-7 h-7 md:w-8 md:h-8 flex items-center justify-center rounded-full border">
                      {isActive ? "−" : "+"}
                    </div>
                  </div>
